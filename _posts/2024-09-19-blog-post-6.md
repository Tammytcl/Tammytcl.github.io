...
$$
d_p = F(M) = F\left(x_p + 1, y_p - \dfrac{1}{2}\right) = b^2 (x_p + 1)^2 + a^2 \left(y_p - \dfrac{1}{2}\right)^2 - a^2 b^2
$$
...
$$
d_p = F(M) = F\left(x_p - \dfrac{1}{2}, y_p +1\right) = b^2 (x_p -\dfrac{1}{2})^2 + a^2 \left(y_p + 1\right)^2 - a^2 b^2
$$
