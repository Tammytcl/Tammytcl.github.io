...
$$
d = \left|\overrightarrow{P_{1}P}\right|\left|\cos\theta\right| = \frac{\left|\overrightarrow{P_{1}P}\cdot \mathbf{n}\right|}{\left|\mathbf{n}\right|} = \frac{\left|Ax_{0} + By_{0} + Cz_{0} + D\right|}{\sqrt{A^{2} + B^{2} + C^{2}}}
$$
...
$$\lim\limits_{\Delta t\rightarrow0}\frac{\Delta \textbf{r\mathit{}}}{\Delta t}=\lim\limits_{\Delta t\rightarrow0}\frac{\textbf{\mathit{f}}(t_{0}+\Delta t)-\textbf{\mathit{f}}(t_{0})}{\Delta t}$$
