...
$$
\iiint_{\Omega} \left( \frac{\partial P}{\partial x} + \frac{\partial Q}{\partial y} + \frac{\partial R}{\partial z} \right) \mathrm{d}v = \oiint_{\Sigma} \left( P \cos \alpha + Q \cos \beta + R \cos \gamma \right) \mathrm{d}S
$$
