...
$$
\iiint\limits_{\Omega} \left( \frac{\partial P}{\partial x} + \frac{\partial Q}{\partial y} + \frac{\partial R}{\partial z} \right) \mathrm{d}v = \oiint\limits_{\Sigma} \left( P \cos \alpha + Q \cos \beta + R \cos \gamma \right) \mathrm{d}S
$$
...
$$
\iiint_{\Omega} \frac{\partial Q}{\partial y} \mathrm{d}v = \oiint_{\Sigma} Q(x,y,z) \mathrm{d}x \mathrm{d}z
$$
...
$$
\oiint_{S} \mathit{\mathbf{F}} \cdot \mathit{\mathbf{n}} \, \mathrm{d}S =
\iiint_{V} \left( \frac{\partial P}{\partial x} + \frac{\partial Q}{\partial y} + \frac{\partial R}{\partial z} \right) \, \mathrm{d}v
$$

或写成

\newcommand{\oiint}{\int\!\!\!\int}

$$
\oiint_{S} \mathit{\mathbf{F}} \cdot \mathit{\mathbf{n}} \, \mathrm{d}S = \iiint_{V} \mathrm{div} \, \mathit{\mathbf{F}} \, \mathrm{d}v
$$
